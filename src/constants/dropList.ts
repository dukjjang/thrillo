export const choosableManagers = [
  ...
  { name: '주호민', image: '/images/profile_image_3.png' },
];
export const defaultProfileImage = '/images/profile_image_unknown.png';
export const states = ['todo', 'inProgress', 'completed'];
